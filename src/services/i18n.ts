...
export const translations = {
  ru: {
    ...
    // Budget & Tzlvt
    budgetWidgetTitle: 'Дневной лимит (Тяжеловато)',
    ...
    noBudgetTitle: '🎯 Лимит трат на период (в стиле Тяжеловато)',
    noBudgetDesc: 'Задайте сумму на месяц, и XPance рассчитает безопасный дневной лимит расхода.',
    setBudgetBtn: 'Задать бюджет',
    budgetModalTitle: 'Бюджет на период (Тяжеловато)',
  ...
  en: {
    ...
    // Budget & Tzlvt
    budgetWidgetTitle: 'Daily Allowance (Tzlvt)',
    ...
    noBudgetTitle: '🎯 Period Budget & Daily Limit (Tzlvt style)',
    noBudgetDesc: 'Set a target amount for the month, and XPance calculates your safe daily burn rate.',
    setBudgetBtn: 'Set Period Budget',
    budgetModalTitle: 'Period Budget (Tzlvt)',
